...
local ADDON_NAME = "PeaversDynamicStats"
local ADDON_ID = "PeaversDynamicStats"
local ICON_PATH = "Interface\\AddOns\\PeaversDynamicStats\\src\\Media\\Icon"

-- Initialize SupportUI namespace
local SupportUI = {}
PDS.SupportUI = SupportUI
...
function SupportUI:InitializeOptions()
    ...
    local supportCategory = Settings.RegisterCanvasLayoutSubcategory(PDS.mainCategory, panel, panel.name)
    PDS.supportCategory = supportCategory
    PDS.supportCategory.ID = panel.name
